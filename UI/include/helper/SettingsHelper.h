...
public:
    ...
    Q_INVOKABLE FluAccentColor *getAccentColor() {
        ...
        accentColor->normal(getAccentColorNormal());
        accentColor->dark(getAccentColorDark());
        accentColor->darker(getAccentColorDarker());
        accentColor->darkest(getAccentColorDarkest());
        accentColor->light(getAccentColorLight());
        accentColor->lighter(getAccentColorLighter());
        accentColor->lightest(getAccentColorLightest());
        return accentColor;
    }
