...
FluScrollablePage{
    ...
    function newTab(){
        tab_view.appendTab("qrc:/main/res/image/favicon.ico",qsTr("Document ")+tab_view.count(),com_page,colors[Math.floor(Math.random() * 8)])
    }
    ...
    function newTab(){
        tab_view.appendTab("qrc:/main/res/image/favicon.ico","Document 1",com_page,argument)
    }
}
'
    }
