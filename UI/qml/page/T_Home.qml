...
FluScrollablePage{
    ...
    ListModel{
        id: model_header
        ListElement{
            icon: "qrc:/main/res/image/logo_pro.png"
        ...
        ListElement{
            icon: "qrc:/main/res/image/ic_home_github.png"
        ...
        ListElement{
            icon: "qrc:/main/res/image/favicon.ico"
    ...
    Item{
        ...
        Image {
            ...
            source: "qrc:/main/res/image/bg_home_header.png"
        }
        Rectangle{
            anchors.fill: parent
            gradient: Gradient{
